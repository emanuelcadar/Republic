        ...
        <div class="main">
          <div class="notification-center">
          	<div class="notification-heading group">
          		<h2 class="nc">NOTIFICATION CENTER <a href="#">2 NEW MESSAGES</a></h2>
                <a href="#" class="rounded-button">SEND A MESSAGE</a>
            </div>
            <div class="navigation-pitches group">
                <ul>
                	<li class="frst"><img src="images/notf-bullet.png" width="20" height="20" alt="bullet"></li>
                    <li class="nc-1">FROM</li>
                    <li class="nc-2">SUBJECT</li>
                    <li class="nc-3">DATE</li>	
                </ul>
            </div>
            <div class="nc-entry">
            	<span class="nc-bullet">
                	<img src="images/notf-bullet.png" width="20" height="20" alt="bullet">
                </span>
                <div class="avt">
                	<a href="#"><img src="images/user.png" width="74" height="74" alt="user"></a>
                </div>
                <span class="snc-1"><a href="#">TechWriter</a></span>
                <span class="snc-2"><a href="#">Join the Comedy Writer’s Guild! </a></span>
                <span>5/13/12</span>
            </div>
            <div class="nc-entry odd-nc">
            	<span class="nc-bullet">
                	<img src="images/notf-bullet.png" width="20" height="20" alt="bullet">
                </span>
                <div class="avt">
            ...
            <div class="nc-entry odd-nc older-nc">
            	<span class="nc-bullet">
