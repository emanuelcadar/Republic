...
<!--      <li class="republic-home"><a title="Republic Home Page" class="home-badge" href="#"></a></li>-->
  ...
  <div class="hero <?php if (($currentPage == "film-index") OR ($currentPage == "createScene") OR ($currentPage == "projectDetails") OR ($currentPage == "projectCharacters") OR ($currentPage == "projectPremise") OR ($currentPage == "projectScenes") OR ($currentPage == "projectScript") OR ($currentPage == "createCharacter")) { echo 'film-index'; } ?>">
    <a class="back-link" href="comedy-home.php">Back to Genre Home</a>
    <h1>The Danny DeVito Project</h1>
    <ul class="sf-sub-menu">
       <li><a <?php if ($currentPage == "film-index") echo 'class="current"' ?> href="film-project-home.php">Project Home</a></li>
