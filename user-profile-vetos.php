            ...
            <div class="user-hero">
            	<div class="user-left">
                    ...
                    <div class="user-all">
                        ...
                        <a href="#" class="active"><span class="vetos">VETOS <em>56</em></span></a>
        ...
        <div class="main">
              <div class="user-profile">
                    <div class="approvals-list">
                        <h3 class="vts">VETOS</h3>
                        <div class="scenes-list">
                        	<span>COMMENT: <a href="#">DANNY DIVITO PROJECT</a>     SCENE 12   </span>
                            <p>Barkley finds Janet’s wedding dress and tears it to shreds, thus ruining the wedding for every attendee.</p>
                        </div>
                        <div class="scenes-list">
                        	<span>SCENE SUGGESTION: <a href="#">DANNY DIVITO PROJECT</a>     SCENE 12   </span>
                            <p>Barkley finds Janet’s wedding dress and tears it to shreds, thus ruining the wedding for every attendee.</p>
                        </div>
                        <div class="scenes-list">
                        	<span>COMMENT: <a href="#">DANNY DIVITO PROJECT</a>     SCENE 12   </span>
                    ...
                    <aside class="latest-activity film-activity trophy-activity no-top-margin">
