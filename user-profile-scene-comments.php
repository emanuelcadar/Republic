        ...
        <?php include( 'header-simple.php' ); ?>
            <div class="user-hero">
            	<div class="user-left">
                    ...
                    <div class="user-all">
                        <a href="#" class="active"><span class="cmts">COMMENTS <em>56</em></span></a>	
        ...
        <div class="main">
            ...
            <ul>
              <li class="single comment-listing">
                ...
                <span>Comment on <a href="#">Scene 12</a> of the <a href="#">Danny Divito Project</a></span>
                <p>Instead of Barkley finding the dress, why don’t you have Gerald throw it in the trash and pee on it?</p>
                <a href="#" class="replies">5 Replies</a>
              </li>
              <li class="single comment-listing">
                <div class="vote-controls">
                    <button class="vote-up"></button>
