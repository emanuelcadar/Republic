    ...
    <div class="container">
        ...
        <div class="main">
          <div class="buttons-test">
          	<a href="#" class="rounded-button">EDIT ACCOUNT</a>
            <a href="#" class="rounded-button following-b">FOLLOWING</a>
            <a href="#" class="rounded-button unfollow-b">UNFOLLOW</a>
            <a href="#" class="rounded-button follow-b">FOLLOW</a>
          </div>
        </div>
